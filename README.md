...
...
  'MdEstatisticas' => array(
      'url' => 'https://estatistica.processoeletronico.gov.br',  //Informada pela equipe do PEN, a partir de Chamado aberto na Central de Atendimento
      'sigla' => 'MPOG',  //Informada pela equipe do PEN, a partir de Chamado aberto na Central de Atendimento
      'chave' => '123456',  //Informada pela equipe do PEN, a partir de Chamado aberto na Central de Atendimento
      'filesystemdu' => false,  //Padrão false. Alterar para true caso seu diretório de arquivos externos seja muito grande ou tenha permissões especiais e o php demore muito tempo para calcular o seu tamanho ou simplesmente não consiga calcular usando suas funções nativas. Nesse caso, o php executará um comando nativo do Linux para calcular o tamanho (du -s -b caminhododirexterno).
      'proxy' => '',  //Padrão vazio. Preencher com o endereço do proxy caso seu servidor use proxy para acessar a internet.
      'proxyPort'=> '',  //Padrão vazio. Preencher com a Porta do proxy caso seu servidor use proxy para acessar a internet.
